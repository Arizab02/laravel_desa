...
<div class="min-h-full">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-navbar.link href="/book">Book</x-navbar.link>
                <x-navbar.link href="/contacts">Contacts</x-navbar.link>
                ...
                <a href="/book" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Book</a>
    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-navbar.dropdown href="/">Home</x-navbar.dropdown>
        <x-navbar.dropdown href="/about">About</x-navbar.dropdown>
        <x-navbar.dropdown href="/book">Book</x-navbar.dropdown>
        <x-navbar.dropdown href="/contact">Contacs</x-navbar.dropdown>
        </div>
